...
public class OperationControllerTest {
    ...
    public void init(){
        ...
        operationDtoList.add(new OperationDto(OperationType.BUY, BigDecimal.TEN, BigDecimal.TEN));

        operationList = new ArrayList<>();
        operationList.add(new Operation(OperationType.BUY, BigDecimal.TEN, BigDecimal.TEN));
